...
%\author{
%
%\IEEEauthorblockN{Bo Xu}
%\IEEEauthorblockA{\textit{Key Laboratory for Ubiquitous Network and Service Software of Liaoning} \\
%\textit{School of Software, Dalian University of Technology}\\
%Dalian, China \\
%boxu@dlut.edu.cn}
%
%\\
%
%\IEEEauthorblockN{ZheHuan Zhao \textsuperscript{*} \thanks{* Corresponding Author}}
%\IEEEauthorblockA{\textit{Key Laboratory for Ubiquitous Network and Service Software of Liaoning} \\
%\textit{School of Software, Dalian University of Technology}\\
%Dalian, China \\
%z.zhao@dlut.edu.cn}
...
%\and
%
%\IEEEauthorblockN{XiuFeng Shi}
%\IEEEauthorblockA{\textit{School of Software} \\
%\textit{Dalian University of Technology}\\
%Dalian, China \\
%shixiufeng@mail.dlut.edu.cn}
%
%\\
%
%\IEEEauthorblockN{Wei Zheng}
%\IEEEauthorblockA{\textit{College of Software} \\
%\textit{Dalian JiaoTong University}\\
%Dalian, China \\
%weizheng@mail.dlut.edu.cn}
%
%\\
%
%\IEEEauthorblockN{ZhiHao Yang}
%\IEEEauthorblockA{\textit{College of Computer Science and Technology} \\
%\textit{Dalian University of Technology}\\
%Dalian, China \\
%yangzh@dlut.edu.cn}
